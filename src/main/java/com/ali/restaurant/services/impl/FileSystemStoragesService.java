...
@Service
@Slf4j
public class FileSystemStoragesService implements StorageService {
    ...
    public String store(MultipartFile file, String fileName) {
        try {
            ...
            String extesion = StringUtils.getFilenameExtension(file.getOriginalFilename());
            String finalFileName = fileName + "." + extesion;
